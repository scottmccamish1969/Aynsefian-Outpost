...
def get_message(category, code, **kwargs):
    messages = {
        "assign": {
            ...
            "process_no_task_data": "DEVELOPER NOTE: No task data found for {name}.",
            ...
            "process_completed": "{name} has finished using the {item}. As a result, {total_units} vials of crystal dust have been generated, and can be used for refueling the PowerSupply.",
        ...
        "charge": {
            ...
            "droid_needs_towing": "{name} is out of charge! They can only be taken to a charging station by a human and there are no idle humans. When one becomes available, they can do it.",
            "getting_low": [
            ...
            "no_target": "{target} for charging is invalid. Try using 'help charge', Commander. A cup of tea might help too.",
            ...
            "not_enough_power_for_charge": "{name} cannot do any {task} because they are low on power and there is only {remaining_power} units of power left in the PowerSupply and a full droid charge requires {needed_power} units.",
            ...
            "tow_declined": "For operational reasons known only to you, {droid_at_zero} will be left where they are for now, lights out and slowly rusting. They can be retrieved later via the 'charge' command.",
            "tow_failed": "DEVELOPER: {name} could not tow the requested droid, as the droid '{droid_to_tow}' was not found.",
            "tow_complete_but_charge_failed": "{droid_to_tow} was successfully towed to the charging station by {name}, but there was not enough power in the PowerSupply to charge them. They will need to be charged later.",
        ...
        "error": {
            ...
            "deceased": "Apologies, Commander, but {name} is (very sadly) deceased and {pronoun} cannot do any tasks requiring strength, movement or concentration at this stage.",
            ...
            "missing_food_task_data": "DEVELOPER: task_data is missing from the task record for {name}'s Eating task - cannot proceed.",
            ...
            "no_power": "Ordinarily it would be a good move using {name} for this task, but since {pronoun} are out of charge, you can't do it.",
            "no_power_for_assign": "Ordinarily it would be a good assigning {name} to this item, but since {pronoun} are out of charge, you can't do it.",
            "no_resume_handler": "DEVELOPER: No resume handler for task type: {task_type}",
            "power_not_found": "POWER STATUS:  No power supply found.",
            "starving": "{name} cannot continue {task_type}. Hunger overwhelms focus and strength. The task has been abandoned.",
            "too_hungry": "Poor old {name} simply can't do any {task} until {pronoun} has been given some food!",
            "too_hungry_for_assign": "Poor old {name} simply can't be assigned to any item until {pronoun} has been given some food!",
            ...
            "unknown_task": "DEVELOPER: Task is unknown.",
            "uninterruptible": "Poor old {name} simply can't do anything until {pronoun} has finished {task}!",
            "unknown_worker": "Cannot get worker '{name}' to do anything at all. This person does not exist.",
        },
        "examine": {
        ...
        "feed": {
            ...
            "fed_A_C_P": "With all fresh food available, {person_name} had {meal_type} {A} apples, {P} potato, and {C} of a cabbage. {pronoun1} seems less vague than {pronoun2} was the day before. 🌱",
            "fed_A_C": "{person_name} had {meal_type} {A} apples and {C} of a cabbage. It wasn’t tasty, but it did the job. 🥬",
            "fed_A_P": "{person_name} ate {meal_type} {A} crispy apples and {P} earthy potatoes. Raw food isn't ideal, but it's better than that ration pack rubbish. 💸",
            "fed_C_P": "Today {person_name} had {meal_type} {P} potatoes and {C} of a cabbage. Some fruit would've been nice, but this will do. 🥬",
            "fed_A": "With only fruit available, {person_name} had {meal_type} {A} apples. Grow some more crops please, Commander. 🍏",
            "fed_C": "Cabbages are the only thing left. {person_name} had {meal_type} {C} of them. Still better than a ration pack. 😟",
            "fed_P": "It's the starch diet for {person_name}. {pronoun1} just had {meal_type} {P} potatoes today. Pray for them. 🥔",
            "fed_a_meal": "{person_name} had some food and feels much better for it. Now {pronoun2} can get back on task: do whatever it takes to get the shield up.",
            "fed_ration": [
            ...
            "fed_two_rations": [
                "{person_name} was forced to eat TWO ration packs because there is no real food available. {pronoun1} now secretly hates you.",
                "You have nothing more edible than a ration pack, and {person_name} is extremely hungry, so they'll eat anything. Thankfully.",
                "The only good thing about {person_name} eating two ration packs is that now there are two less of these in the Outpost. That can only be good.",
                "{person_name} had two ration packs because of extreme hunger. If you had a sick bay at this Outpost, you'd be readying it. But you don't, so just hope for the best, Commander."
            ],
            "fed_ration_and_produce": "{person_name} has had {meal_type} {real_food} plus the horror of a ration pack. With real food included {pronoun2} might yet survive to old age.",
            "food_all_used_up": "{person_name} cannot be fed as there is no food left! You will need to grow some crops quickly, Commander.",
            "food_waiting": "You graciously allow {name} to wait for food to arrive from somewhere, rather than forcing {pronoun} to work while hungry. Kudos to you.",
            "food_returned": "Change of plans: the food that {name} was going to eat is now returned to the FoodStore.",
            "food_not_returned": "DEVELOPER: No food found in the queued task. Cannot return it to the FoodStore.",
            "food_skipped": "The shield must go up! {name} will continue working until food arrives. Which, for {pronoun} sake, better be soon, Commander.",
            ...
            "last_ration": "It might be barely edible, but it prevents death via starvation. {person_name} just took the last ration pack.",
            ...
            "unable_to_reserve_food": "There is unfortunately not enough food for {name}. Hopefully you planted something, Commander, and it will ripen soon.",
            "waiting_for_food": "{name} is waiting for food and cannot do anything else until it arrives."
        },
        "feed_droid": {
            "responses": [
        ...
        "hunger": {
            ...
            "NearDeath": "{name} is near death from lack of food! Find {pronoun2} some nourishment somewhere, quickly!",
            "Starving": "{name} is starving! Unfortunately {pronoun3} ability to do any sort of work is curtailed until food is provided.",
