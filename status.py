...
from constants import (ENDGAME_REASONS, FULL_CHARGE, HUNGER, NUM_HUMANS, NUM_DROIDS, LOW_CHARGE_FLAG, IDLE_CHARGE_USAGE, 
                      TASK_ASSIGNED, TASK_EXAMINING, TASK_EATING, TASK_CHARGING, TASK_REAPING, TASK_PLANTING)
from lore.user_interface import (log_and_display, get_input, msg_food, msg_power, msg_info, msg_plant,
                                 msg_error, msg_info, msg_crystal, msg_resource, msg_shield)
